        ...
        <div class="menu-inner">
          <nav>
            <ul class="metismenu" id="menu">
              ...
              <li><a href="index.php?sayfa=aracfilo"><i class="ti-car"></i><span>Araç Filosu</span></a></li>
              <li><a href="index.php?sayfa=hakkimiz"><i class="ti-flag"></i><span>Hakkımızda Ayarlar</span></a></li>
              <li><a href="index.php?sayfa=hizmetler"><i class="ti-medall"></i><span>Hizmetler Ayarlar</span></a></li>
              <li><a href="index.php?sayfa=ref"><i class="ti-eye"></i><span>Refarans Ayarları</span></a></li>
